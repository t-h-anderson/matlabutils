classdef DragController < gwidgets.internal.table.TableController
    ...
    methods
        ...
        function onBridgeDragStart(this, data)
            ...
            owner = this.owner();
            owner.emitTableEvent("DragStarted", gwidgets.table.TableEventData( ...
                Action="start", ...
                DisplayIndices=reshape(sourceSelection.DisplayRows, 1, []), ...
                DataIndices=reshape(sourceSelection.DataRows, 1, []), ...
        ...
        function onBridgeDrop(this, data)
            ...
            owner = this.owner();
            requestEvent = owner.emitTableEvent("DropRequested", gwidgets.table.TableEventData( ...
                Action="drop", ...
                DisplayIndices=reshape(targetSelection.DisplayRows, 1, []), ...
                DataIndices=reshape(targetSelection.DataRows, 1, []), ...
                SourceSelection=sourceSelection, ...
                TargetSelection=targetSelection, ...
                Operation=operation, ...
                Placement=targetSelection.Placement, ...
                Payload=data));
            ...
            try
                ...
                owner.emitTableEvent("DropCompleted", gwidgets.table.TableEventData( ...
                    Action="drop", ...
                    DisplayIndices=reshape(targetSelection.DisplayRows, 1, []), ...
                    DataIndices=reshape(targetSelection.DataRows, 1, []), ...
                    SourceSelection=sourceSelection, ...
