classdef CallbackController < gwidgets.internal.table.TableController
    ...
    methods
        ...
        function onCellEdit(this, source, eventData)
            ...
            displayIdx = eventData.Indices;
            dataIdx = owner.eventDisplayToData(displayIdx, "cell");
            requestEvent = owner.emitTableEvent("CellEditRequested", gwidgets.table.TableEventData( ...
                Action="edit", ...
                DisplayIndices=displayIdx, ...
                DataIndices=dataIdx, ...
            ...
            if requestEvent.HasReplacementData
                eventData.NewData = requestEvent.ReplacementData;
            end
        ...
        function onDisplayDataChanged(this, source, eventData)
            ...
            owner = this.owner();
            requestEvent = owner.emitTableEvent("DisplayDataChangeRequested", ...
                gwidgets.table.TableEventData( ...
                Action=string(eventData.Interaction), ...
                Command=string(eventData.Interaction), ...
