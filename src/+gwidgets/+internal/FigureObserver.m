classdef ( Sealed ) FigureObserver < handle
    ...
    methods
        ...
        function obj = FigureObserver( subject )
            % FigureObserver  Create figure observer
            %
            %  o = FigureObserver(s) creates a figure observer for the
            %  subject s.
            ...
            if ~isprop( subject, 'Parent' )
                error( 'GWidgets:ParentNotAProperty', ...
        ...
        function onParentPostSet( obj, ~, ~ )
            ...
            if ~isequal( oldFigure, newFigure )
                notify( obj, 'FigureChanged', ...
                    gwidgets.internal.FigureData( oldFigure, newFigure ) )
            end
